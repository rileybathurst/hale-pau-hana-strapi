...
export interface ApiAmenitieAmenitie extends Schema.SingleType {
...
export interface ApiDepartureDeparture extends Schema.SingleType {
...
export interface ApiRateRate extends Schema.SingleType {
  ...
  attributes: {
    vrbo: Attribute.String;
    taxId: Attribute.String;
    checkin: Attribute.Time;
    checkout: Attribute.Time;
    taxRate: Attribute.Decimal;
    cleaning: Attribute.Blocks;
    direct: Attribute.Blocks;
    rates: Attribute.Blocks;
    peak_season_start: Attribute.Date;
    peak_season_end: Attribute.Date;
    peak_rate: Attribute.Integer;
    off_season_rate: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
